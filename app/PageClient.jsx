    ...
    <div
        className={[
          ...
          !prefersReducedMotion
            ? "transition-[opacity,backdrop-filter,transform] duration-[450ms] ease-[cubic-bezier(0.18,1,0.32,1)]"
            : "",
        ].join(" ")}
        role="dialog"
        aria-modal="true"
      ...
      <div className="relative w-full max-w-md overflow-hidden px-2">
        <div
            className={[
              ...
              !prefersReducedMotion
                ? "transition-[transform,opacity,filter] duration-[390ms] ease-[cubic-bezier(0.18,1,0.32,1)]"
                : "",
